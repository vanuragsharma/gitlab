...
class Data extends AbstractHelper
{
    ...
    const PROCEEDTOCHECKOUTBUTTON = 'emailquote/general/proceedtocheckoutenable';
    ...
    public function getProceedToCheckoutButtonEnabled()
    {
        return $this->scopeConfig->getValue(self::PROCEEDTOCHECKOUTBUTTON, ScopeInterface::SCOPE_STORE);
    }
