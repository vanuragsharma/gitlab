...
class Categories extends \Magento\Config\Block\System\Config\Form\Field\FieldArray\AbstractFieldArray {
    /**
     * Grid columns
     *
     * @var array
    ...
    protected function _prepareToRender() {
        ...
        $this->addColumn('categories', array('label' => __('Category name')));
