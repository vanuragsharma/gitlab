    ...
    public function insertLogo(&$page, $store = null)
    {
        ...
        if ($image) {
            ...
            if ($this->_mediaDirectory->isFile($imagePath)) {
                ...
                $W = $this->_scopeConfig->getValue('sales/identity/logo_width',\Magento\Store\Model\ScopeInterface::SCOPE_STORE,$store);
                $H = $this->_scopeConfig->getValue('sales/identity/logo_height',\Magento\Store\Model\ScopeInterface::SCOPE_STORE,$store);
