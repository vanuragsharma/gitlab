...
class StockMovementAfterDelete implements ObserverInterface
{
    ...
    public function execute(EventObserver $observer)
    {
        ...
        {
            $this->_logger->log('Update physical quantity for product #'.$productId.' in warehouse #'.$warehouseId.' (after delete)', \BoostMyShop\AdvancedStock\Helper\Logger::kLogInventory);
