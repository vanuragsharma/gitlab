<?php namespace BoostMyShop\AdvancedStock\Block\StockTake\Apply;

/**
 * Class Grid
 *
 * @package   BoostMyShop\AdvancedStock\Block\StockTake\Apply
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended {
    ...
    {
        $collection = $this->_stockTakeItemCollectionFactory->create()
            ->addFieldToFilter('stai_stock_take_id', $this->getStockTake()->getId());

        $collection->addStockTakeModeConditionForApplication($this->getStockTake()->getsta_mode());
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('stai_sku', ['header' => __('Sku'), 'index' => 'stai_sku']);
        ...
        $this->addColumn('stai_scanned_qty', ['header' => __('Scanned Qty'), 'index' => 'stai_scanned_qty', 'type' => 'range']);
        ...
        $this->addColumn('stock_movement_message',
            [
                'header' => __('Stock Movement message'),
                'renderer' => '\BoostMyShop\AdvancedStock\Block\StockTake\Widget\Grid\Column\Renderer\Apply\StockMovementMessage',
                'filter' => false,
                'sortable' => false
            ]
        );
    ...
    public function getGridUrl()
    {
        ...
        return $this->getUrl('advancedstock/stocktake_apply/grid', $params);
    }
