 ...
 * Class Sku
 *
 * @package   BoostMyShop\AdvancedStock\Block\StockTake\Widget\Grid\Column\Renderer\Edit\Tabs\Add
...
class Sku extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer {
    ...
    public function render(\Magento\Framework\DataObject $row) {
        ...
        $url = $this->getUrl('catalog/product/edit', ['id' => $row->getId(), 'active_tab' => '']);
