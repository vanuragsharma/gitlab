...
class WarehouseDelayRanges extends \Magento\Config\Block\System\Config\Form\Field
{
    protected $_config;
    ...
    protected function _prepareLayout()
    {
        ...
        if (!$this->getTemplate()) {
            $this->setTemplate('system/config/warehouseDelayRanges.phtml');
        }
        return $this;
    }
    ...
    public function getFieldValue($type, $index)
    {
        ...
        return $this->_config->getSetting('instock/'.$type.'_'.$index, $scopeId, $scope);
    }
