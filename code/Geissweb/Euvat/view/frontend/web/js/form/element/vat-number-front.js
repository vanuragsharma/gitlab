...
define([
    ...
    return BaseVatNumber.extend({
        ...
        initialize: function (options) {
            ...
            }, $t(this.validVatRequiredMessage));

            $.validator.addMethod('valid-vat-if-specified', function () {
                return self._ruleValidVatIfSpecified();
            }, $t(this.validVatIfSpecifiedMessage));

            $.validator.addMethod('valid-vat-if-company-specified', function () {
                return self._ruleValidVatIfCompanySpecified();
            }, $t(this.validVatIfCompanySpecifiedMessage));
