...
define([
    ...
    return Abstract.extend({
        ...
        defaults: {
            ...
            validVatIfCompanySpecifiedMessage: $t('Please type a valid VAT number in this field, or leave the company field empty.'),
            delay: 3000,
        ...
        validate: function () {
            ...
            var result = validator(this.validation, value);
        ...
        _ruleValidVat: function () {
            ...
            if(!this.visible()) {
                if (this.debug) {
                    console.log("_ruleValidVat not visible");
                }
                return true;
            }
            ...
            if($.isArray(this.euCountries) && $.inArray(country, this.euCountries) === -1
                ...
                if (this.debug) {
                    console.log("_ruleValidVat non-EU");
                }
                return true;
            }
            ...
            if(Utils.isEmpty(this.value())) {
                if (this.debug) {
                    console.log("_ruleValidVat is empty");
                }
                return false;
            }
            ...
            if (this.visible()) {
                if (!this.enableAjaxValidation && this.passedRegex()) {
                    if (this.debug) {
                        console.log("_ruleValidVat offline passed");
                    }
                    return true;
                }
                if (this.debug) {
         ...
         * @private
         */
        _ruleValidVatIfSpecified: function () {
            if (this.visible() && typeof(this.value()) === 'string' && this.value().length > 0) {
                return this._ruleValidVat();
            }
            if (this.debug) {
                console.log('base _ruleValidVatIfSpecified (no value)', this.value());
            }
            return true;
        },
         ...
         * @private
         */
        _ruleValidVatIfCompanySpecified: function () {
            if(!this.visible()) {
                return true;
            }
