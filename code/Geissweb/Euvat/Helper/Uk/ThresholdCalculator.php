...
class ThresholdCalculator
{
    ...
    public function __construct(
        ...
        $adminSessionQuote = $this->backendSessionQuote->getQuote();
        if ($adminSessionQuote !== null) {
    ...
    public function isDeliveryToUk()
    {
        ...
        if ($this->adminSessionQuote !== null) {
            if ($this->adminSessionQuote->getIsVirtual()) {
                return false;
            }
            return $this->isAddressInUk($this->adminSessionQuote->getShippingAddress());
        }
    ...
    public function isCurrentCartAbove($threshold)
    {
        ...
        if ($this->adminSessionQuote !== null) {
            return $this->getPriceInGBP($this->adminSessionQuote->getSubtotalWithDiscount()) > $threshold;
        }
