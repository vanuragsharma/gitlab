 ...
 */
namespace Catchers\Custom\Controller\Account;
...
class EditPost extends \Magento\Customer\Controller\Account\EditPost
{
    ...
    public function execute()
    {
        ...
        if ($validFormKey && $this->getRequest()->isPost()) {
			...
			//echo "<pre>";
			//print_r($customerCandidateDataObject);
			//die;
            ...
            try {
                ...
                $customer = $objectManager->create('Magento\Customer\Model\Customer')->load($this->session->getCustomerId());
                $customer->setData('cc_email_new', $this->getRequest()->getParam('cc_email_new'));
                $customer->setData('cc_email_invoice', $this->getRequest()->getParam('cc_email_invoice'));
                $customer->setData('cc_email_shipment', $this->getRequest()->getParam('cc_email_shipment'));
                $customer->save();
                

                $customerCandidateDataObject->setData('cc_email_new', $this->getRequest()->getParam('cc_email_new'));
				$customerCandidateDataObject->setData('cc_email_invoice', $this->getRequest()->getParam('cc_email_invoice'));
				$customerCandidateDataObject->setData('cc_email_shipment', $this->getRequest()->getParam('cc_email_shipment'));
                //$customerCandidateDataObject->setCcEmailInvoice($this->getRequest()->getParam('cc_email_invoice'));
               // $customerCandidateDataObject->setCcEmailShipment($this->getRequest()->getParam('cc_email_shipment'));
