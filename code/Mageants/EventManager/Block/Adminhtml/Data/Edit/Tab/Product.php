 ...
 * Created By : RH
 */
namespace Mageants\EventManager\Block\Adminhtml\Data\Edit\Tab;
...
class Product extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \Mageants\EventManager\Model\ResourceModel\Eventdata\CollectionFactory $productCollFactory,
    ...
    protected function _construct()
    {
        ...
        /*if ($this->getRequest()->getParam('e_id')) {
   ...
   protected function _getSelectedProducts()
    {
        $eventid = $this->getRequest()->getParam('e_id');
        //var_dump($eventid);exit();
        $eventdata = $this->_Eventdata->create();
        $eventdata->load($eventid);
        $productsids = $eventdata->getProductassign();
        $products = explode(',', $productsids);
        if ($products === null) {   
            $vProducts = $this->productFactory->create()
    ...
    public function getSelectedProducts()
    {
        ...
        $model = $this->productCollFactory->create()->addFieldToFilter('e_id', $id);
        $grids = [];
        foreach ($model as $key => $value) {
            $grids[] = $value->getProductAssign();
        }
        $prodId = [];
