...
class Customer extends \Magento\Eav\Model\Entity\VersionControl\AbstractEntity
{
     ...
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    public function loadByEmail(\Yalla\Apis\Model\Customer\Model\Customer $customer, $email)
    {
        $connection = $this->getConnection();
     ...
     * @return $this
     */
    public function changePassword(\Yalla\Apis\Model\Customer\Model\Customer $customer, $newPassword)
    {
    ...
    public function setNewIncrementId(\Magento\Framework\DataObject $object)
    {
        if ($this->_scopeConfig->getValue(
            \Yalla\Apis\Model\Customer\Model\Customer::XML_PATH_GENERATE_HUMAN_FRIENDLY_ID,
     ...
     * @return $this
     */
    public function changeResetPasswordLinkToken(\Yalla\Apis\Model\Customer\Model\Customer $customer, $passwordLinkToken)
    {
