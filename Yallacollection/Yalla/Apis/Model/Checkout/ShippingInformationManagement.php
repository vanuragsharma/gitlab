...
namespace Yalla\Apis\Model\Checkout;
...
class ShippingInformationManagement implements \Magento\Checkout\Api\ShippingInformationManagementInterface
{
    ...
    public function saveAddressInformation(
        ...
        /*
         * If shipping address method is not set then set shipping method again
         * */
        if(empty($shippingAddress->getShippingMethod())) {
            $shippingAddress->setShippingMethod($carrierCode . '_' . $methodCode)->save();
        }
